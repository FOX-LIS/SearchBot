...
public class IndexServiceImpl implements IndexService {
    ...
    public IndexingResponse startIndexing() {
        List<SiteItem> sitesList = sites.getSites();
        for (SiteItem site : sitesList) {
    ...
    private IndexingResponse getPageData(Site site, String url) {
        try {
    ...
    private void saveIndexedSiteStatus(Site site) {
